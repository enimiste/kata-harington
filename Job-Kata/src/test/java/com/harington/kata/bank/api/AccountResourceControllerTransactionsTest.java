...
public class AccountResourceControllerTransactionsTest {
    ...
    public void should_update_account_balance_when_do_deposit() throws Exception {
        ...
        mockMvc.perform(post(String.format(API_BASE_URL, accountNumber))
                ...
                .andExpect(header().string(HttpHeaders.LOCATION, "/api/v1/accounts/" + accountNumber + "/transactions"))
    ...
    @Test
    public void should_return_empty_list_when_no_transations_history_found_for_an_existing_account() throws Exception {
        UUID accountNumber = UUID.randomUUID();
    ...
    @Test
    public void should_return_error_when_transations_history_requested_for_no_existing_account() throws Exception {
        UUID accountNumber = UUID.randomUUID();
        Mockito.when(transactionService.getTransactionsHistoryFor(Mockito.any()))
                .thenThrow(EntityNotFoundException.class);
    ...
    @Test
    public void should_return_empty_list_when_transations_history_found() throws Exception {
        UUID accountNumber = UUID.randomUUID();
        ...
        Mockito.when(transactionService.getTransactionsHistoryFor(Mockito.any()))
                .thenReturn(List.of(
                        TransactionDto.builder()
                                ...
                                .transactionAt(DatesFormatter.format(now.minusDays(100)))
                                .operation(Transaction.TxType.DEPOSIT.name())
                                .build(),
                        TransactionDto.builder()
                                .txRef(UUID.randomUUID().toString())
